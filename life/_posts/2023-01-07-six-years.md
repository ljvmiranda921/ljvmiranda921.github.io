...
header-img: /assets/images/six-years/header.png
excerpt: |
...
<!-- figure -->
![](/assets/images/six-years/inputs.png){:width="700px"}
...
![](/assets/images/six-years/quad.png){:width="700px"}
{: style="text-align: center;"}
...
![](/assets/images/six-years/inspiration.png){:width="700px"}
{: style="text-align: center;"}
