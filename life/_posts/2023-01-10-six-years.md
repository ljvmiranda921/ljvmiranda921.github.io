...
Nevertheless, I learned that **marketing starts even before writing.** For example,
during pre-writing, I learned to use tools like [Moz](https://moz.com) to search
for keywords that I can use to title a blog post. After writing, I use tools
like [Plausible](https://plausible.io) to know which communities read my posts
to learn where to share next time. My hard and fast rule is that when I labor
over a problem or a concept, and the resources on the internet are inadequate,
it's a good sign that it may be a good topic for a blog post. I then use the
abovementioned tools to verify if my intuition is correct.
...
I record the date, a short one-liner about how the post has changed (a la git
...
[**annealing**](https://www.swyx.io/blogpost-annealing): like metal, we apply heat
in the form of feedback, etc., on a blog post to shape it in a better form.
