...
I study **edge language models**, or small models that can run on commodity devices or under limited connectivity, with the motivation of enabling the development and deployment of language technologies for the Global South.

I want to find out how we can pack strong capabilities that the Global South cares about into a small model footprint, given that most of these communities don't have the resources to run models at frontier scale.
...
I'm interested in techniques such as synthetic data generation, sustainable human data collection, knowledge distillation, and building faithful benchmarks (among many others).
...
* [Gumagana ba talaga yan sa Filipino? Evaluating and Building Language Models for the Philippines](https://docs.google.com/presentation/d/1KOdSsFsk8io59bKRzwU-4u1iFNxDumlSNLQfUYgbTfU/edit?usp=sharing). *Analytics & AI Association of the Philippines*. Hosted by Michelle Alarcon. 2026.
