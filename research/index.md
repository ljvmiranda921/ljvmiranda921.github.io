...
The works listed below were instrumental to my growth as a researcher. Recently,
I've [shifted my focus](#interests) to computational linguistics. Feel free to check out my [Google Scholar](https://scholar.google.co.jp/citations?user=2RtnNKEAAAAJ&hl=en) page:
...
<b><a id="interests">What am I working on</a></b><br>
In recent years, I've been interested in problems that involve the <i>creative and resourceful
application of NLP under severe constraints</i>, either from lack of data (e.g., low-resource languages,
multilingual NLP) or lack of compute (e.g., efficient NLP). If you're interested in these topics
and want to collaborate, then feel free to <a href="mailto:ljvmiranda@gmail.com">hit me up</a>!</p>
