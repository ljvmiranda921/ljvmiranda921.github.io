...
published: true
filipino_nlp: true
header-img: /assets/images/filbench/header.png
tags:
  [
    nlp,
    language technology,
...
description: |
  This National Language Month, I'm proud to introduce FilBench, a big step forward in Filipino NLP evaluation.
  This work was also accepted at EMNLP Main!
  Read to learn more about this project.
excerpt: |
...
<iframe
  src="https://filbench-filbench-leaderboard.hf.space"
	frameborder="1"
	width="800"
	height="500"
></iframe>
...
- **Paper**: {% cite miranda2025 --file projects/filbench.bib %}
...
{% include figure.html
   src="/assets/images/filbench/filbench_main.svg"
   width="300"
   caption="An overview of FilBench, a benchmark and leaderboard for evaluating LLMs on Filipino." %}
...
I'm also thankful to [Nathan Habib](https://github.com/NathanHB), [Clementine Fourrier](https://clefourrier.github.io/), and [Daniel van Strien](https://danielvanstrien.xyz/) for their feedback on the [official HuggingFace blog post](https://huggingface.co/blog/filbench).
...
{% bibliography --file projects/filbench.bib %}
