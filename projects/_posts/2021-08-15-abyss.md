...
seemingly disparate set of skills.** It's not just about programming, there's
also design both in art and gameplay. At first it seemed overwhelming: I need
to write code, make assets, plan gameplay, and more! However, if I want to
finish my game within scope ([see #1](#1-limit-your-scope)), I need to play
with my strengths.
