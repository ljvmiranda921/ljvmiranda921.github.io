...
**I can only go so far learning on my own.** If I want to keep my momentumeven
...
welcoming, and they cater to both amateurs and professionals alike.

Surrounding myself with like-minded individuals helps me keep my momentum. I
get to ask for feedback, share my work, and connect with others. They inspired
me to finish my game, and to keep pursuing game development as a hobby!


## 5. Don't forget to have fun!

Earlier, I mentioned that my goal is to create a game that I myself will be
delighted to play. Since these are hobbies, having *fun* and *delight*  serve
...
> But eventually they [programs] will break...Time and tide will wash them away...  
> But that doesn't mean you shouldn't build things anyway.
> Just because something is going to break in the end doesn't mean that it
> can't have  an effect that lasts into the future. 
>
...
![](/assets/png/abyss/CreditsScreen.png){:width="500px" style="border-radius:8px;"}  
{: style="text-align: center;"}
