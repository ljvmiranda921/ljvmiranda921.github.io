...
* Batteries included: complex algorithms is just a subclass away (e.g., 
...
try to wrap my head around. For example, Nodes and Scenes took me some time,
signals remind me of Vue's `$emit`, and my project structure is not yet
idiomatic. 
