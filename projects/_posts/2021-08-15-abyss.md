...
author: "LJ V. MIRANDA"
published: true
header-img: /assets/images/abyss/header.png
...
{% include figure.html
   src="/assets/images/abyss/three_act_structure.png"
   width="640"
   caption="Three-act structure for my roguelike" %}
...
{% include figure.html
   src="/assets/images/abyss/eA0Pv9h.gif"
   width="640"
   caption="My #screenshotsaturday progress" %}
...
<img style="float: right; margin:6px" width="380px"  src="/assets/images/abyss/mental_inventory.png">
...
<!--
![](/assets/images/abyss/mental_inventory.png){:width="460px"}  
<br />
...
<!--
<img style="float: right; border-radius:8px; margin:6px" width="380px"  src="/assets/images/abyss/fog_of_war.gif">
-->

<!-- insert raycasting gif -->
{% include figure.html
   src="/assets/images/abyss/fog_of_war.gif"
   width="500"
   class="rounded"
   caption="With Godot, I can just use the builtin raycasting algorithm to simulate fog of war." %}
...
![](/assets/images/abyss/act1.png){:width="300px" height="180px" style="border-radius:8px; padding-bottom:6px"}
![](/assets/images/abyss/act2.png){:width="300px" height="180px" style="border-radius:8px; padding-bottom:6px"}  
![](/assets/images/abyss/act3.png){:width="300px" height="180px" style="border-radius:8px;padding-bottom:6px"}
![](/assets/images/abyss/boss_fight.gif){:width="300px" height="180px" style="border-radius:8px;padding-bottom:6px"}  
{: style="text-align: center;"}
...
<!-- example of tilesets -->
![](/assets/images/abyss/UndwldDemoTileset.png){:width="300px" style="border-radius:8px"}
![](/assets/images/abyss/CavernTileset.png){:width="300px" style="border-radius:8px"}
{: style="text-align: center;"}
...
<!--
![](/assets/images/abyss/DemoL2Enemies.gif){:width="500px"}
{: style="text-align: center;"}
-->


<img style="float: right; border-radius:8px; padding:10px;" width="360px"  src="/assets/images/abyss/CharacterDemo.png">
<img style="float: right; border-radius:8px; margin:8px;" width="360px"  src="/assets/images/abyss/slash_animation.gif">
...
<!--
![](/assets/images/abyss/CharacterDemo.png){:width="360px"}
{: style="text-align: center;"}
![](/assets/images/abyss/slash_animation.gif){:width="500px" style="border-radius:8px;"}  
{: style="text-align: center;"}
-->
...
![](/assets/images/abyss/CreditsScreen.png){:width="640px" style="border-radius:8px;"}  
{: style="text-align: center;"}
