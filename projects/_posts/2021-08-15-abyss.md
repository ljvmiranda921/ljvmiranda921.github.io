...
![](/assets/png/abyss/fog_of_war.gif){:width="520px"}  
<br />
...
![](/assets/png/abyss/act1.png){:width="360px"}
![](/assets/png/abyss/act2.png){:width="360px"}  
{: style="text-align: center;"}

![](/assets/png/abyss/act3.png){:width="360px"}
![](/assets/png/abyss/boss_fight.gif){:width="360px"}  
{: style="text-align: center;"}
...
<!-- example of tilesets -->
![](/assets/png/abyss/UndwldDemoTileset.png){:width="360px"}
![](/assets/png/abyss/CavernTileset.png){:width="360px"}
{: style="text-align: center;"}
