...
![PySwarms](/res/pyswarms/pyswarms-header.png){:width="640px"}
...
However, if one is to look at published literature, there is a multitude of variations in the standard
...
![Cost History](/res/pyswarms/output_9_0.png){:width="560px"}   
...
![3D particle movement](/res/pyswarms/output_3d.gif){:width="560px"}   
