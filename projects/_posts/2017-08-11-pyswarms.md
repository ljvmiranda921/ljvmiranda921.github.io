...
![PySwarms](/assets/images/pyswarms/pyswarms-header.png){:width="640px"}
...
{% include figure.html
   src="/assets/images/pyswarms/output_9_0.png"
   width="560"
   alt="Cost History"
   caption="_Calling the `plot_cost()` method generates a cost history line plot._" %}
...
{% include figure.html
   src="/assets/images/pyswarms/output_3d.gif"
   width="560"
   alt="3D particle movement"
   caption="_Particle movement generated by calling the `plot_particles3D()` method._" %}
