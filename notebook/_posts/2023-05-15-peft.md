...
LLaMa-Adapter (Zhang et al,. 2023). The mechanism is similar to prefix tuning
...
<!-- i find this class of techniques (collectively known as p*-tuning) interesting
because it opens up different ways to update the input

it might be interesting to do some post-hoc analysis on the dependency of these learned
weights to the data or domain. Similar to adapters, aggregating these soft prompts might be an
