...
network) and its task-specific capabilities (modular network). We can even
aggregate these modules to solve multi-domain ([Gurugangan et al.,
2022](#gurugangan2022demix); [Chronopoulou et al.,
2023](#chronopoulou2023adaptersoup); [Asai et al., 2022](#asai2022attempt)) or
multilingual problems ([Pfeiffer et al., 2020](#pfeiffer2020madx); [Pfeiffer et al., 2021](#pfeiffer2021unks)).
