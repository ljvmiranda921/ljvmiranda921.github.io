...
Houlsby et al. (2019) first proposed the use of adapters in the context of NLP.
...
<!-- insert image of diagram with adapters attached -->
<!-- insert high-level pseudocode with adapters attached -->
...
skip-connection. According to Houlsby et al. (2019), they were able to limit the
number of trainable parameters to $$0.5-8\%$$ of the original model.

<!-- insert image of adapter diagram -->
<!-- insert high-level pseudocode with adapters attached -->

From then on, researchers have proposed different adapter architectures. One notable
development is from Pfeiffer et al. (2021), where they reduced the number of adapters
significantly by attaching only one per transformer layer. 
<!-- talk about a few new archi, maybe take some from pfeiffer's talk in cohere -->
...
- <a id="chronopoulou2023adaptersoup">Alexandra Chronopoulou, et al.</a> "Adaptersoup: Weight averaging to improve generalization of pretrained language
