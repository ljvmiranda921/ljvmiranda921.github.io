...
trained on a masked language modeling and next sentence prediction), it is
...
However, this process has slowly become inefficient ([Treviso et al.,
...
inaccessible in resource constrained environments and consumer-grade hardware.
Hence, an efficient finetuning approach is becoming more desirable.
