...
up-projection, similar to autoencoders. Lastly, the adapter also contains an
internal skip-connection. According to Houlsby et al. (2019), they were able to
limit the number of parameters from $$0.5$$ to $$8\%$$ of the original model.

<!-- insert image of adapter diagram -->
<!-- insert high-level pseudocode with adapters attached -->

From then on, researchers have proposed different adapter architectures. 
