...
([Vaswani et al., 2017](#vaswani2017attention)). Let's review their architecture
as they'll be useful for understanding the PEFT techniques later on. Most transformer networks
consist of a stack of encoder and decoder layers with an attention mechanism:
