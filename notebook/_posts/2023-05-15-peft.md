...
multi-domain, multi-task, or multilingual problems.[^2] They enable another level of
flexibility to PEFT:
...
complexity of the training set-up. Just like in engineering, it's possible to go full-kubernetes
when you can just use a simple virtual machine (or a cloud function). 
-->
