...
![](/assets/png/peft/encoder_with_adapter_houlsby.png){:width="500px"}  
{:style="text-align: center;"}
...
how we constructed our prompt. Language is productively combinatorial: it will
take a lot of time to find the right "incantation" so that our LLM performs
optimally. This begs the question: what if we can learn our prompts?

> Text is infinitely combinatorial...what if we can learn our prompts?
...
[^3]:
    ...
    To tell you the truth, I read their paper many times and I can't seem to
    find the differences between the two. The experiments and applications are
    different though (e.g., one leans more to autoregressive LLMs), but the mechanics
    are the same. 

<!-- insert figure: https://lightning.ai/pages/community/article/understanding-llama-adapters/ -->
<!-- insert pseudocode -->

<!-- talk about detailed differences -->
<!-- check some other soft prompt papers -->
...
- <a id="brown2020incontext">Tom Brown, et al</al>. "Language models are few-shot learners." Advances in neural information processing systems 33 (2020): 1877-1901.
