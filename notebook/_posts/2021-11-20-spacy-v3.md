...
author: "LJ V. MIRANDA"
published: true
header-img: /assets/images/spacy-v3/header.png
...
{% include figure.html
   src="/assets/images/spacy-v3/spacy_stack_full.png"
   width="380"
   caption="My view of the spaCy stack. Abstraction increases as you go up." %}
...
{% include figure.html
   src="/assets/images/spacy-v3/user_intxn_config.png"
   width="800"
   caption="I can interact with the config via the spaCy CLI. It is already included whenever I install spaCy" %}
...
{% include figure.html
   src="/assets/images/spacy-v3/user_intxn_data.png"
   width="800"
   caption="Unless your dataset follows common formats, you need to write a data processing script to convert them into `DocBin`, then into the disk." %}
...
{% include figure.html
   src="/assets/images/spacy-v3/user_intxn_full.png"
   width="800"
   caption="Common user workflow for spaCy CLI and its configuration system" %}
...
![](/assets/images/spacy-v3/spacy_stack_config.png){:width="380px"}
...
{% include figure.html
   src="/assets/images/spacy-v3/user_intxn_partial.png"
   width="700"
   caption="You can manage your config by filling a partial set of values first, then hydrating them with the full set of options." %}
...
{% include figure.html
   src="/assets/images/spacy-v3/training_section.png"
   width="700"
   caption="Notice that the `batcher` is a function (a `Callable`)." %}
...
{% include figure.html
   src="/assets/images/spacy-v3/batcher_demo_00.png"
   width="680"
   caption="The `batcher` parameter for training can still be configured further, so it earns its own subsection." %}
...
![](/assets/images/spacy-v3/training_batchers.png){:width="700px"}
{: style="text-align: center;"}
...
{% include figure.html
   src="/assets/images/spacy-v3/batcher_demo_01.png"
   width="680"
   caption="Similar to `batcher`, we can configure the `size` further." %}
...
{% include figure.html
   src="/assets/images/spacy-v3/thinc_stack.png"
   width="300"
   caption="[Thinc](https://thinc.ai) is a layer that powers spaCy's compute capabilities. It offers a refreshing take on deep learning frameworks via a functional paradigm. It also exists as [a standalone library](https://github.com/explosion/thinc)" %}
...
![](/assets/images/spacy-v3/spacy_stack_projects.png){:width="340px"}
{: style="text-align: center;"}
...
{% include figure.html
   src="/assets/images/spacy-v3/user_intxn_projects.png"
   width="640"
   caption="The spaCy project now abstracts our training config file. You can use the `project.yml` file to manage our whole machine learning workflow. We can then use the `spacy project run <STEP>` to execute [steps](https://spacy.io/usage/projects#run) or [workflows](https://spacy.io/usage/projects#run-workfow)." %}
