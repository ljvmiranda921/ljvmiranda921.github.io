...
sports news article made it a bit incomprehensible.
    ...
    <iframe src="/assets/images/splits/wasserstein-sample-00.html" height="300" width="720" style="border:1px solid #ddd;border-radius:10px;position:absolute;top:0;left:0;bottom:0;right:0;width:100%;height:100%;"></iframe>
    </div>
    <br/>
...
has `PER`, `ORG`, `LOC`, and `MISC` as its entity types.
    ...
    <div style="position:relative; overflow: hidden; width;100%; padding-top: 56.25%">
    <iframe src="/assets/images/splits/wasserstein-sample-01.html" height="300" width="720" style="border:1px solid #ddd;border-radius:10px;position:absolute;top:0;left:0;bottom:0;right:0;width:100%;height:100%"></iframe>
    </div>
    <br/>
...
text.
    ...
    <div style="position:relative; overflow: hidden; width;100%; padding-top: 56.25%">
    <iframe src="/assets/images/splits/wasserstein-sample-02.html" height="300" width="720" style="border:1px solid #ddd;border-radius:10px;position:absolute;top:0;left:0;bottom:0;right:0;width:100%;height:100%"></iframe>
    </div>
    <br/>
...
<iframe src="/assets/images/splits/context_example.html" height="100" width="720" style="border:1px solid #ddd;border-radius:10px;position:absolute;top:0;left:0;bottom:0;right:0;width:100%;height:100%"></iframe>
</div>
<br/>
...
![](/assets/images/splits/wnut17.png){:width="600px", style="padding:10px"}  
...
- **Example 1:** A text with token length 105. This document is one of the top 5 longest texts in the WNUT17 dataset.
    ...
    <iframe src="/assets/images/splits/doclength-sample-01.html" height="100" width="720" style="border:1px solid #ddd;border-radius:10px;position:absolute;top:0;left:0;bottom:0;right:0;width:100%;height:100%"></iframe>
    </div>
    <br/>
...
as a `product` instead of a `person`.
    ...
    <iframe src="/assets/images/splits/doclength-sample-02.html" height="100" width="720" style="border:1px solid #ddd;border-radius:10px;position:absolute;top:0;left:0;bottom:0;right:0;width:100%;height:100%"></iframe>
    </div>
    <br/>
...
- **Example 1:** A document from the new test set where tokens with a morph feature
    ...
    <div style="position:relative; overflow: hidden; width;100%; padding-top: 52.25%">
    <iframe src="/assets/images/splits/morph-sample-01.html" height="100" width="720" style="border:1px solid #ddd;border-radius:10px;position:absolute;top:0;left:0;bottom:0;right:0;width:100%;height:100%"></iframe>
    </div>
    <br/>
...
- **Example 2:** This is an interesting example because
    ...
    <div style="position:relative; overflow: hidden; width;100%; padding-top: 52.25%">
    <iframe src="/assets/images/splits/morph-sample-00.html" height="100" width="720" style="border:1px solid #ddd;border-radius:10px;position:absolute;top:0;left:0;bottom:0;right:0;width:100%;height:100%"></iframe>
    </div>
    <br/>
...
|----------------------|------------------------|---------------------------|
| WikiNEuRal (English) | 0.87 / 0.86 / 0.87     |  **0.85 / 0.82 / 0.83**     |
| WNUT17               | **0.47** / 0.45 / 0.46     | 0.65 / **0.26** / **0.37**    |
| CoNLL 2003 (English) | 0.86 / 0.86 / 0.86     | **0.86 / 0.79 / 0.82**    |
...
- **Example 1:** A sports news report where all player names are replaced with
    ...
    <div style="position:relative; overflow: hidden; width;100%; padding-top: 52.25%">
    <iframe src="/assets/images/splits/switch-sample-00.html" height="100" width="720" style="border:1px solid #ddd;border-radius:10px;position:absolute;top:0;left:0;bottom:0;right:0;width:100%;height:100%"></iframe>
    </div>
    <br/>
...
{% bibliography --file notebook/splits.bib %}
