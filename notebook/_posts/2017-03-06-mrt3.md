...
{% include figure.html
   src="/assets/images/mrt3/ridership.png"
   width="640"
   alt="Passenger Count"
   caption="MRT-3 Ridership" %}
...
{% include figure.html
   src="/assets/images/mrt3/passenger-traffic-01.png"
   width="720"
   alt="Passenger Traffic"
   caption="Passenger Traffic throughout the day" %}
...
{% include figure.html
   src="/assets/images/mrt3/flux.gif"
   width="720"
   alt="Passenger Flux"
   caption="Passenger Flux" %}
