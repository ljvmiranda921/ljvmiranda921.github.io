...
**Example 1:** A text of length 32. 

<div style="position:relative; overflow: hidden; width;100%; padding-top: 20.25%">
<iframe src="/assets/png/splits/doclength-sample-00.html" height="100" width="720" style="border:1px solid #ddd;border-radius:10px;position:absolute;top:0;left:0;bottom:0;right:0;width:100%;height:100%"></iframe>
</div>
<br/>


**Example 2:** A text of length 105.
