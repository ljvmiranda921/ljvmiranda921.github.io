...
### <a id="circumvent"></a> We can circumvent the data scarcity problem...
...
### <a id="bootstrapping"></a> ...by bootstrapping the data we have
...
### <a id="corrected"></a> I corrected annotations from a silver model...
...
### <a id="benchmarked"></a> ...then benchmarked it with baseline NER approaches
...
## <a id="results"></a> Experimental Results
...
### <a id="word-vector-setup"></a> Finding the best word vector training setup
...
### <a id="language-model-setup"></a> Finding the best language model training setup
...
### <a id="eval-pipelines"></a> Evaluating our pipelines
